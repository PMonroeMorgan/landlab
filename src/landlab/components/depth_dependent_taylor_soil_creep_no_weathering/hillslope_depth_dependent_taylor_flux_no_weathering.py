...
class DepthDependentTaylorDiffuserNoWeathering(Component):
    r"""
    This component is a modified version of depthdependenttaylordiffuser to not include weathering so
    that the user can use their own weathering component.
    ...
    **Additional References**
    ...
    def __init__(
        ...
        #self._dynamic_dt = dynamic_dt # change to always false, so weathering rate matches
        self._dynamic_dt = False
    ...
    def _update_flux_topography_soil_and_bedrock(self):
        ...
        #dhdt = self._soil_prod_rate - dqdx # comment bc no weathering!
        dhdt = - dqdx
        ...
        # bedrock elev doesn't change bc weathering already happened in dif function
